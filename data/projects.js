...
export const projects = [
  ...
  },
  {
    ...
    title: "ClipOn and Move Free",
    tagline: "A product hook built to land before the scroll continues.",
    year: "2026",
    format: "9:16",
    runtime: "00:00:19",
    role: "AI Creative Direction · Edit",
    description:
      "A fast, single-hook product short for Anker's Soundcore ClipOn earbuds — built for vertical feeds, with a clean edit rhythm designed to hold attention in under 20 seconds.",
    tools: ["CapCut", "AI Video Generation"],
    image: "https://i.ytimg.com/vi/ECWUmg_RpjA/maxresdefault.jpg",
    videoUrl: "https://youtube.com/shorts/ECWUmg_RpjA",
  },
  {
    scene: "04",
    category: "UGC Ads",
